...
layout = [
    [sg.Text("Converts all xlsx and xls files under the selected conversion source folder to csv.")],
    [sg.Text("The converted csv file will be placed under the converted folder, keeping the folder structure.")],
    [
        sg.InputText(
    ...
    [
        ...
        sg.FolderBrowse(
            button_text="Select", key="-CONVERTED-FOLDER-BROWSE-"
        ),
    ],
    [sg.Submit()],
]
